...
namespace DMS.WebAPI.Controllers
{
    public class DealersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DealerID,DealerName,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate")] Dealer dealer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DealerID,DealerName,CreatedBy,CreatedDate,UpdatedBy,UpdatedDate")] Dealer dealer)
        {
            if (ModelState.IsValid)
            {
